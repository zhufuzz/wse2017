...
if os.environ['REQUEST_METHOD'] == 'GET':
	...
	for i in range(0,numQuestions):
		...
		for j in range(0, numChoices):
			print "<input type=radio name=q"+str(i)+" value="+choices[j]+">"+choices[j]
			print "<input type=hidden name=a"+str(i)+" value="+choices[j]+">"
			# print "<p>"+"q "+str(i)+" value="+choices[j]
		#print "</li>"
	print answers
...
if os.environ['REQUEST_METHOD'] == 'POST':
	...
	for i in range(0, numQuestions):
		...
		try:
			print "q" + str(i)
			#print "question is "+form["q" + str(i)].value
			print "answer is "+form["a" + str(i)].value
