...
""" Specify keywords / search terms here in comma separated value format """
...
""" Set the date manually by adjusting the line below.  Or set the script to 
automatically generate and search based on the current date.  To change it to 
automatic, replace "Feb 28" value without the quotes 
